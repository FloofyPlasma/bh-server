...
@interface Blockhead : DynamicObject <PathUserDynamicObject, HarmableDynamicObject>
{
    ...
    Vector<unsigned short, std::__1::allocator<unsigned short>> expectedCraftItems;
    BOOL visible;
...
- (BOOL)hasActions;
- (BOOL)queueActionWithGoalPos:(intpair)arg1 goalInteraction:(int)arg2 pathType:(int)arg3 interactionObjectID:(unsigned long long)arg4 craftableItemObject:(id)arg5 craftCountOrExtraData:(short)arg6 disableCancelCheck:(BOOL)arg7 isAI:(BOOL)arg8;
- (BOOL)queueActionWithGoalPos:(intpair)arg1 goalInteraction:(int)arg2 pathType:(int)arg3 interactionObjectID:(unsigned long long)arg4 craftableItemObject:(id)arg5 craftCountOrExtraData:(short)arg6 isAI:(BOOL)arg7;
- (BOOL)hasCancelableActionAtGoalPos:(intpair)arg1 orWithInteractionObjectID:(unsigned long long)arg2 goalInteraction:(int)arg3 craftCountOrExtraData:(short)arg4;
- (BOOL)cancelAnyActionAtGoalPos:(intpair)arg1 orWithInteractionObjectID:(unsigned long long)arg2 goalInteraction:(int)arg3 craftCountOrExtraData:(short)arg4;
...
- (int)currentInteractionTypeForTile:(struct Tile *)arg1 atPos:(intpair)arg2 pickupRejectedDueToInventoryFull:(char *)arg3 includeActions:(BOOL)arg4 faceIndex:(int)arg5 allowProtectedActions:(BOOL)arg6;
- (int)currentInteractionType;
- (int)currentInteractionIsGoodOrBad;
- (BOOL)canDigBackWallforTile:(struct Tile *)arg1 atPos:(intpair)arg2 withItem:(id)arg3 includeActions:(BOOL)arg4;
- (int)interactionTypeForTile:(struct Tile *)arg1 atPos:(intpair)arg2 item:(id)arg3 pickupRejectedDueToInventoryFull:(char *)arg4 includeActions:(BOOL)arg5 faceIndex:(int)arg6 allowProtectedActions:(BOOL)arg7;
...
- (id)initWithWorld:(id)arg1 dynamicWorld:(id)arg2 atPosition:(intpair)arg3 cache:(id)arg4 blockheadNumber:(int)arg5 craftableItemObject:(id)arg6 uniqueID:(unsigned long long)arg7;
- (int)objectType;

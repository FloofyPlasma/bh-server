...
@class BlockheadAI, CPTexture2D, DrawCube, FishingRod, InteractionObject, InventoryItem, MJSound, MJTextView, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableIndexSet, NSString, Shader, Workbench;
@protocol HarmableDynamicObject, RidableDynamicObject;

@interface Blockhead : DynamicObject <PathUserDynamicObject, HarmableDynamicObject>
{
    ...
    struct Vector hatItemColor;
    struct Vector shirtItemColor;
    struct Vector pantsItemColor;
    struct Vector shoesItemColor;
    ...
    CDStruct_ffe6b7c1 prevFromSquare;
    CDStruct_ffe6b7c1 fromSquare;
    CDStruct_ffe6b7c1 toSquare;
    CDStruct_ffe6b7c1 nextToSquare;
    ...
    CDStruct_ffe6b7c1 lastKnownRideObjectPosition;
    ...
    CDStruct_ffe6b7c1 ignoringFreeblocksDueToDropLocation;
    NSString *name;
    float idleTimer;
    ...
    struct Vector artificialLightDirection;
    BOOL waitingForPath;
    ...
    struct vector<unsigned short, std::__1::allocator<unsigned short>> expectedCraftItems;
    BOOL visible;
    ...
    struct Vector2 jetPackIncomingAcceleration;
    struct Vector2 jetPackVelocity;
    struct Vector2 smoothedJetPackVelocity;
    ...
    CDStruct_ffe6b7c1 netNextToSquare[4];
    ...
    struct Vector2 floatPosWhenDPadMovementStarted;
    struct Vector2 lastDPadTotalDistance;
    struct Vector2 lastDPadTotalDistanceSmoothed;
}

@property(readonly) struct TradeMission currentTradeMission; // @synthesize currentTradeMission;
@property(readonly) NSArray *actionQueue; // @synthesize actionQueue;
@property int tipType; // @synthesize tipType;
@property(readonly) BOOL cancelSimulateDueToCollapse; // @synthesize cancelSimulateDueToCollapse;
@property(readonly) float currentTemperature; // @synthesize currentTemperature;
@property BOOL isClientBlockheadBeingControlledByServer; // @synthesize isClientBlockheadBeingControlledByServer;
@property(readonly) BOOL isCurrentlyActiveBlockheadAccordingToNetData; // @synthesize isCurrentlyActiveBlockheadAccordingToNetData;
@property(readonly) DynamicObject<RidableDynamicObject> *rideObject; // @synthesize rideObject;
...
@property(readonly) NSArray *saveItemSlotsArray; // @synthesize saveItemSlotsArray;
...
- (struct Vector2)distanceTravelledThisDPadMovementSinceLastRequest;
- (BOOL)beingControlledByDPad;
...
- (id)localNetID;
- (BOOL)waitingForFillRequestAtPos:(CDStruct_ffe6b7c1)arg1;
- (BOOL)doubleTimeUnlocked;
- (BOOL)canEnterFreeFlightMode;
- (BOOL)teleportToPos:(CDStruct_ffe6b7c1)arg1;
- (BOOL)canTeleportToPos:(CDStruct_ffe6b7c1)arg1;
...
- (BOOL)hasActions;
- (BOOL)queueActionWithGoalPos:(CDStruct_ffe6b7c1)arg1 goalInteraction:(int)arg2 pathType:(int)arg3 interactionObjectID:(unsigned long long)arg4 craftableItemObject:(id)arg5 craftCountOrExtraData:(short)arg6 disableCancelCheck:(BOOL)arg7 isAI:(BOOL)arg8;
- (BOOL)queueActionWithGoalPos:(CDStruct_ffe6b7c1)arg1 goalInteraction:(int)arg2 pathType:(int)arg3 interactionObjectID:(unsigned long long)arg4 craftableItemObject:(id)arg5 craftCountOrExtraData:(short)arg6 isAI:(BOOL)arg7;
- (BOOL)hasCancelableActionAtGoalPos:(CDStruct_ffe6b7c1)arg1 orWithInteractionObjectID:(unsigned long long)arg2 goalInteraction:(int)arg3 craftCountOrExtraData:(short)arg4;
- (BOOL)cancelAnyActionAtGoalPos:(CDStruct_ffe6b7c1)arg1 orWithInteractionObjectID:(unsigned long long)arg2 goalInteraction:(int)arg3 craftCountOrExtraData:(short)arg4;
- (void)remotePickupRequestResponse:(BOOL)arg1 uniqueIDs:(unsigned long long *)arg2 count:(int)arg3;
...
- (void)fishingRodCast:(struct Vector2)arg1;
- (BOOL)allowsPanning;
- (float)cameraZOffset;
- (struct Vector2)cameraPos;
- (void)swipeUpGesture;
- (BOOL)motionShouldBeDiscreteValues;
- (void)setMotion:(struct Vector2)arg1;
...
- (id)currentItem;
- (void)setCurrentItemToItemAtIndex:(CDStruct_ffe6b7c1)arg1;
- (id)currentItemSlot;
...
- (int)moveInventoryItemsFromArray:(id)arg1 fromIndex:(int)arg2 fromSubIndex:(int)arg3 toIndex:(int)arg4 toSubIndex:(int)arg5 count:(int)arg6 movedItems:(id)arg7;
- (void)removeInventoryItemsFromIndex:(int)arg1 fromSubIndex:(int)arg2 count:(int)arg3;
- (int)moveInventoryItemsFromIndex:(int)arg1 fromSubIndex:(int)arg2 toIndex:(int)arg3 toSubIndex:(int)arg4 count:(int)arg5;
- (void)dropInventoryItemsAtIndex:(int)arg1 subIndex:(int)arg2 count:(int)arg3 ignoreFreeblocks:(BOOL)arg4;
...
- (void)incrementUsageOfItem:(id)arg1 indexToUse:(int)arg2 wasAttack:(BOOL)arg3 multiplier:(int)arg4;
- (void)incrementUsageOfItem:(id)arg1 indexToUse:(int)arg2 wasAttack:(BOOL)arg3;
- (id)subtractItemsFromInventoryOfType:(int)arg1 count:(int)arg2 dataB:(int)arg3;
- (id)subtractItemsFromInventoryOfType:(int)arg1 count:(int)arg2;
- (void)itemWillBeRemovedFromInventory:(id)arg1;
- (CDStruct_ffe6b7c1)mostCommonFoodTypeIndex;
- (CDStruct_ffe6b7c1)placableLightForAIItemIndex;
- (int)placableLightForAIItemType;
- (CDStruct_ffe6b7c1)sowableItemForAIItemIndex;
- (int)sowableItemForAIItemType;
- (CDStruct_ffe6b7c1)itemIndexWithGoodInteractionTypeForTile:(struct Tile *)arg1;
- (void)subtractCash:(int)arg1;
- (int)totalCash;
- (CDStruct_ffe6b7c1)inventoryLocationOfFirstInstanceOfItemType:(int)arg1;
- (float)usageMultiplierForFirstItemOfType:(int)arg1;
- (int)countOfInventoryItemsOfType:(int)arg1 includeActions:(BOOL)arg2;
- (int)countOfInventoryItemsWithSpecificDataBOfType:(int)arg1 dataB:(int)arg2 includeActions:(BOOL)arg3;
- (id)inventoryItems;
- (BOOL)pickupFreeblockIfPossible:(id)arg1 inTile:(struct Tile *)arg2 intentional:(BOOL)arg3;
- (int)addItemToInventory:(id)arg1 flash:(BOOL)arg2 disableWarpCheck:(BOOL)arg3 forceSlotIndex:(int)arg4;
...
- (int)canPickUpItemOfType:(int)arg1 subItems:(id)arg2 dataA:(unsigned short)arg3 dataB:(unsigned short)arg4;
...
- (void)drawBoxes:(float)arg1 projectionMatrix:(union _GLKMatrix4)arg2 modelViewMatrix:(union _GLKMatrix4)arg3 pinchScale:(float)arg4 cameraMinXWorld:(int)arg5 cameraMaxXWorld:(int)arg6 cameraMinYWorld:(int)arg7 cameraMaxYWorld:(int)arg8;
...
- (void)drawTransparentInventoryItem:(float)arg1 projectionMatrix:(union _GLKMatrix4)arg2 modelViewMatrix:(union _GLKMatrix4)arg3 cameraMinXWorld:(int)arg4 cameraMaxXWorld:(int)arg5 cameraMinYWorld:(int)arg6 cameraMaxYWorld:(int)arg7;
...
- (void)drawForButtonProjectionMatrix:(union _GLKMatrix4)arg1 modelViewMatrix:(union _GLKMatrix4)arg2;
- (void)sufferDamage:(float)arg1 isSimulation:(BOOL)arg2 recoil:(BOOL)arg3;
- (void)pickUpItemIfPossibleInTile:(struct Tile *)arg1 atPos:(CDStruct_ffe6b7c1)arg2;
- (id)pickupItemForTile:(struct Tile *)arg1 astPos:(CDStruct_ffe6b7c1)arg2;
...
- (BOOL)canSleepOnSpot;
- (BOOL)canCollapse;
- (struct FreeBlockCreationCount)freeBlockCreationCountForTile:(struct Tile *)arg1 withItem:(id)arg2;
...
- (int)currentInteractionTypeForTile:(struct Tile *)arg1 atPos:(CDStruct_ffe6b7c1)arg2 pickupRejectedDueToInventoryFull:(char *)arg3 includeActions:(BOOL)arg4 faceIndex:(int)arg5 allowProtectedActions:(BOOL)arg6;
- (int)currentInteractionType;
- (int)currentInteractionIsGoodOrBad;
- (BOOL)canDigBackWallforTile:(struct Tile *)arg1 atPos:(CDStruct_ffe6b7c1)arg2 withItem:(id)arg3 includeActions:(BOOL)arg4;
- (int)interactionTypeForTile:(struct Tile *)arg1 atPos:(CDStruct_ffe6b7c1)arg2 item:(id)arg3 pickupRejectedDueToInventoryFull:(char *)arg4 includeActions:(BOOL)arg5 faceIndex:(int)arg6 allowProtectedActions:(BOOL)arg7;
...
- (id)initWithWorld:(id)arg1 dynamicWorld:(id)arg2 saveDict:(id)arg3 savedInventorySlots:(id)arg4 cache:(id)arg5 repositionOnLoadFailure:(BOOL)arg6 clientSaveDir:(id)arg7 clientLocallySavedDict:(id)arg8;
- (id)initWithWorld:(id)arg1 dynamicWorld:(id)arg2 atPosition:(CDStruct_ffe6b7c1)arg3 cache:(id)arg4 blockheadNumber:(int)arg5 craftableItemObject:(id)arg6 uniqueID:(unsigned long long)arg7;
- (int)objectType;

...
@class BHServer, Database, NSMutableArray, NSMutableDictionary, NSMutableIndexSet, NSString;
...
@interface ServerClient : NSObject
{
    ...
    struct map<unsigned int, unsigned char, std::__1::less<unsigned int>, std::__1::allocator<std::__1::pair<const unsigned int, unsigned char>>> requestedBlockRequestTypes;
...
@property(readonly) NSMutableIndexSet *foundItemsList; // @synthesize foundItemsList;
@property map_183b77d1 *worldIndicesContainingTamedAnimals; // @synthesize worldIndicesContainingTamedAnimals;
@property(readonly) int lightBlockIndex; // @synthesize lightBlockIndex;
@property float timeSinceLastHeartbeatRequest; // @synthesize timeSinceLastHeartbeatRequest;
@property BOOL hasEverRequestedHeartbeat; // @synthesize hasEverRequestedHeartbeat;
@property BOOL requestsHeartBeat; // @synthesize requestsHeartBeat;
@property(readonly) NSMutableIndexSet *wiredDynamicObjects; // @synthesize wiredDynamicObjects;
...
- (void)addUpdateObjectDataToSend:(id)arg1 ofType:(unsigned char)arg2 reliable:(BOOL)arg3;
- (void)addCreationDataUpdateObjectDataToSend:(id)arg1 ofType:(unsigned char)arg2;
- (void)addCreationObjectDataToSend:(id)arg1 ofType:(unsigned char)arg2 objectID:(unsigned long long)arg3;
...
- (id)initWithClientID:(id)arg1 server:(id)arg2 lightBlockIndex:(int)arg3 lightBlockDatabase:(id)arg4;

...
- (int)gemItemType;
- (int)treeType;
- (void)recursivelyAddOwnedTile:(CDStruct_ffe6b7c1)arg1 toPositions:(unordered_set_22babbde *)arg2;
...
- (id)initWithWorld:(id)arg1 dynamicWorld:(id)arg2 atPosition:(CDStruct_ffe6b7c1)arg3 cache:(id)arg4 treeDensityNoiseFunction:(id)arg5 seasonOffsetNoiseFunction:(id)arg6 gemTreeType:(int)arg7;

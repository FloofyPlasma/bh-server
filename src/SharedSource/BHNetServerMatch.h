...
- (id)initWithPort:(id)arg1 userName:(id)arg2 photo:(id)arg3 hasLocalPLayer:(BOOL)arg4 worldName:(id)arg5 credit:(float)arg6 cloudSalt:(id)arg7 ownerName:(id)arg8 privacy:(id)arg9;

...
@class Database, DatabaseEnvironment, NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, World;
...
- (id)modifyListForPlayerOrIP:(id)arg1 isAdded:(BOOL)arg2 listType:(int)arg3 banUDID:(BOOL)arg4;
...
- (void)sendChatMessage:(id)arg1 displayNotification:(BOOL)arg2 sendToClients:(id)arg3;
...
- (id)initWithDelegate:(id)arg1 match:(id)arg2 netNodeType:(long long)arg3 saveID:(id)arg4 maxPlayers:(int)arg5;

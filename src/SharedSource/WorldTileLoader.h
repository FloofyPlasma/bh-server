...
- (BOOL)sendLightBlockToClientWithoutSavingForBlock:(struct PhysicalBlock *)arg1 pos:(intpair)arg2 sendToClient:(id)arg3 server:(id)arg4;
...
- (void)fillDirtTile:(struct Tile *)arg1 worldPos:(intpair)arg2 worldDirtHeight:(int)arg3 parentType:(int)arg4;
...
- (BOOL)sendBlockToClientWithoutSavingForBlock:(struct PhysicalBlock *)arg1 pos:(intpair)arg2 sendToClient:(id)arg3 server:(id)arg4 sendDynamicObjects:(BOOL)arg5 reliable:(BOOL)arg6;

...
@property(readonly) NoiseFunction
    *seasonOffsetNoiseFunction; // @synthesize seasonOffsetNoiseFunction;
@property(readonly) NoiseFunction
    *treeDensityNoiseFunction; // @synthesize treeDensityNoiseFunction;

...
@interface WorldTileLoader : NSObject
{
    ...
    int *npcPositions;
    int *plantPositions;
    CDStruct_ffe6b7c1 bestStartPosition;
...
@property(readonly) Database *lightBlockDatabase; // @synthesize lightBlockDatabase;
@property(readonly) float yHeightDivider; // @synthesize yHeightDivider;
@property(readonly) int xFrequencyMultiplier; // @synthesize xFrequencyMultiplier;
@property BOOL needsToExit; // @synthesize needsToExit;
@property(readonly) CDStruct_ffe6b7c1 highestPoint; // @synthesize highestPoint;
...
@property(readonly) CDStruct_ffe6b7c1 bestStartPosition; // @synthesize bestStartPosition;
...
- (void)saveLightBlockForClientLightBlockIndex:(int)arg1 clientID:(id)arg2 physicalBlock:(struct PhysicalBlock *)arg3 sendNow:(BOOL)arg4;
- (BOOL)sendLightBlockToClientWithoutSavingForBlock:(struct PhysicalBlock *)arg1 pos:(CDStruct_ffe6b7c1)arg2 sendToClient:(id)arg3 server:(id)arg4;
- (void)loadLightBlockForClientLightBlockIndex:(int)arg1 clientID:(id)arg2 intoPhysicalBlock:(struct PhysicalBlock *)arg3;
...
- (CDStruct_ffe6b7c1)findBestStartPosition;
- (void)loadPhysicalBlock:(struct PhysicalBlock *)arg1 atXPos:(int)arg2 yPos:(int)arg3 createIfNotCreated:(BOOL)arg4;
- (void)placeGemsInCaveForPhysicalBlock:(struct PhysicalBlock *)arg1 tileIndex:(int)arg2 worldX:(int)arg3 worldY:(int)arg4 floatingIslandType:(int)arg5;
- (void)recursivelyFlowOutDirtFromTile:(struct Tile *)arg1 atPos:(CDStruct_ffe6b7c1)arg2;
- (void)recursivelyFlowOutWaterFromTile:(struct Tile *)arg1 atPos:(CDStruct_ffe6b7c1)arg2;
- (void)fillDirtTile:(struct Tile *)arg1 worldPos:(CDStruct_ffe6b7c1)arg2 worldDirtHeight:(int)arg3 parentType:(int)arg4;
- (BOOL)isDesertOrBeachForPos:(CDStruct_ffe6b7c1)arg1 height:(int)arg2;
- (BOOL)isBeachForPos:(CDStruct_ffe6b7c1)arg1 height:(int)arg2;
- (BOOL)isDesertForPos:(CDStruct_ffe6b7c1)arg1 height:(int)arg2;
...
- (void)savePhysicalBlock:(struct PhysicalBlock *)arg1 macroTile:(struct MacroTile *)arg2 sendToClients:(id)arg3 server:(id)arg4 sendReliably:(BOOL)arg5;
- (BOOL)sendBlockToClientWithoutSavingForBlock:(struct PhysicalBlock *)arg1 pos:(CDStruct_ffe6b7c1)arg2 sendToClient:(id)arg3 server:(id)arg4 sendDynamicObjects:(BOOL)arg5 reliable:(BOOL)arg6;
...
- (float)sandstoneFractionForX:(int)arg1 y:(int)arg2 faultOffset:(int)arg3 limestoneFraction:(float)arg4;
...
- (void)getInitialRockAndDirtHeightforX:(int)arg1 rockHeight:(float *)arg2 dirtHeight:(float *)arg3;
- (void)refineTerrain;
- (void)dealloc;
- (void)compressBlocks;
- (id)initWithWorld:(id)arg1 randomSeed:(unsigned int)arg2 isNewWorld:(BOOL)arg3 saveID:(id)arg4 loadedVersion:(int)arg5 blockDatabase:(id)arg6;

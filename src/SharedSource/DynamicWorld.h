...
@interface DynamicWorld //! : NSObject
{
    ...
    Vector<DynamicObject *, std::__1::allocator<DynamicObject *>> partialUpdateOrderedObjects[65];
...
- (BOOL)isServer;
- (BOOL)isClient;
- (void)loadNewBlockheadAtPos:(intpair)arg1 craftableItemObject:(id)arg2 uniqueID:(unsigned long long)arg3;
...
- (id)checkForHarmableDynamicObjectUnderTap:(Vector2)arg1 ignoreLocalBlockheads:(BOOL)arg2 ignoreAllBlockheads:(BOOL)arg3;
...
- (void)placeTrainCarAtPos:(intpair)arg1 ofType:(int)arg2 saveDict:(id)arg3 placedByClient:(id)arg4;
- (id)boatWithID:(unsigned long long)arg1;
- (id)checkForBoatUnderTap:(Vector2)arg1;
- (void)placeBoatInWaterAtPos:(intpair)arg1 saveDict:(id)arg2 placedByClient:(id)arg3;
...
- (void)addWindowAtPos:(intpair)arg1 ofType:(int)arg2 saveDict:(id)arg3 placedByClient:(id)arg4;
...
- (void)addElevatorMotorAtPos:(intpair)arg1 ofType:(int)arg2 saveDict:(id)arg3 placedByClient:(id)arg4;
...
- (void)addElevatorShaftAtPos:(intpair)arg1 ofType:(int)arg2 saveDict:(id)arg3 placedByClient:(id)arg4;
- (id)elevatorShaftAtPos:(intpair)arg1;
- (id)removeWireAtPos:(intpair)arg1;
- (id)wireAtPos:(intpair)arg1;
- (void)addWireAtPos:(intpair)arg1 ofType:(int)arg2 saveDict:(id)arg3 placedByClient:(id)arg4;
- (id)removeStairsAtPos:(intpair)arg1;
- (void)addStairsAtPos:(intpair)arg1 ofType:(int)arg2 saveDict:(id)arg3 placedByClient:(id)arg4;
- (id)stairsAtPos:(intpair)arg1;
- (id)removeColumnAtPos:(intpair)arg1;
- (void)addColumnAtPos:(intpair)arg1 ofType:(int)arg2 saveDict:(id)arg3 placedByClient:(id)arg4;
- (id)columnAtPos:(intpair)arg1;
- (id)removeLadderAtPos:(intpair)arg1;
- (void)addLadderAtPos:(intpair)arg1 ofType:(int)arg2 saveDict:(id)arg3 placedByClient:(id)arg4;
- (id)ladderAtPos:(intpair)arg1;
- (void)addStandardObjectAtPos:(intpair)arg1 objectType:(int)arg2 itemType:(int)arg3 saveDict:(id)arg4 placedByClient:(id)arg5;
- (id)removePaintingAtPos:(intpair)arg1;
- (void)addPaintingAtPos:(intpair)arg1 ofType:(int)arg2 saveDict:(id)arg3 placedByClient:(id)arg4 clientName:(id)arg5;
...
- (void)createTreasureChestOrTrollAtTile:(struct Tile *)arg1 atPos:(intpair)arg2 loadTroll:(BOOL)arg3 loadTreasure:(BOOL)arg4;
...
- (void)addTorchAtPos:(intpair)arg1 ofType:(int)arg2 dataA:(unsigned short)arg3 dataB:(unsigned short)arg4 saveDict:(id)arg5 placedByClient:(id)arg6;
- (id)placeFireAtPosition:(intpair)arg1;
- (id)interactionObjectPlacedAtPosition:(intpair)arg1 withItem:(id)arg2 flipped:(BOOL)arg3 saveDict:(id)arg4 placedByClient:(id)arg5 clientName:(id)arg6;
- (id)workbenchPlacedAtPosition:(intpair)arg1 ofType:(int)arg2 saveDict:(id)arg3 placedByClient:(id)arg4 clientName:(id)arg5;
- (void)loadPlantAtPosition:(intpair)arg1 type:(int)arg2 maxAgeGene:(short)arg3 growthRateGene:(short)arg4 adult:(BOOL)arg5;
- (BOOL)loadNPCAtPosition:(intpair)arg1 type:(int)arg2 saveDict:(id)arg3 isAdult:(BOOL)arg4 wasPlaced:(BOOL)arg5 placedByClient:(id)arg6;
...
- (void)loadTreeAtPosition:(intpair)arg1 type:(int)arg2 maxHeight:(short)arg3 growthRate:(short)arg4 adultTree:(BOOL)arg5 adultMaxAge:(float)arg6;
- (void)sowTreeOrPlantAtPosition:(intpair)arg1 itemType:(int)arg2 maxHeight:(short)arg3 growthRate:(short)arg4;
...
- (int)activeBlockheadIndex;
- (id)activeBlockhead;
- (void)lightChangedAtMacroPos:(intpair)arg1 sendReliably:(BOOL)arg2 sendAtAll:(BOOL)arg3;
- (void)snowChangedAtMacroPos:(intpair)arg1;
- (void)lightChangedAtMacroPos:(intpair)arg1 sendReliably:(BOOL)arg2;
- (void)exploreLightChangedAtMacroPos:(intpair)arg1 clientLightBlockIndex:(int)arg2;
...
- (void)createBackgroundContentFreeBlockAtPosition:(intpair)arg1 forTile:(struct Tile *)arg2 removeBlockhead:(id)arg3;
- (id)freeblockWithUniqueID:(unsigned long long)arg1;
- (void)createFreeBlockAtPosition:(intpair)arg1 forForegroundContents:(BOOL)arg2 forTile:(struct Tile *)arg3 priorityBlockhead:(id)arg4;
- (void)playTimeCrystalReceivedSoundAtPos:(intpair)arg1;
- (void)createFreeBlockAtPosition:(intpair)arg1 ofType:(int)arg2 dataA:(unsigned short)arg3 dataB:(unsigned short)arg4 subItems:(id)arg5 dynamicObjectSaveDict:(id)arg6 hovers:(BOOL)arg7 playSound:(int)arg8 priorityBlockhead:(id)arg9;

...
@property(readonly) Vector2 roundedTranslation; // @synthesize roundedTranslation;
...
- (void)ownershipSignWasPlacedOrChangedAtPos:(intpair)arg1 withLandOwner:(id)arg2 widthRadius:(int)arg3 heightRadius:(int)arg4 wasRemoved:(BOOL)arg5;
- (void)signOwnershipModificationRecievedFromServer:(id)arg1;
- (void)updateLocalOwnershipSignsDueToSignPlacedOrChangedAtPos:(intpair)arg1 withLandOwner:(id)arg2 widthRadius:(int)arg3 heightRadius:(int)arg4 wasRemoved:(BOOL)arg5;
...
- (void)fireProjectileFrom:(Vector2)arg1 to:(Vector2)arg2 at:(id)arg3 fireItemType:(int)arg4 firer:(id)arg5;
- (void)zoomToPortalAtPosition:(intpair)arg1;
- (void)incentivizedVideoViewComplete:(BOOL)arg1;
- (BOOL)mapVisible;
- (BOOL)tileIsLitForClient:(id)arg1 atPos:(intpair)arg2 tile:(struct Tile *)arg3;
...
- (intpair)getBlockheadZoomPosForClient:(id)arg1 requesterClient:(id)arg2 cycleIndex:(int)arg3;
...
- (void)iapStarted;
- (void)waterMovedFrom:(intpair)arg1 fromTile:(struct Tile *)arg2 to:(intpair)arg3 toTile:(struct Tile *)arg4 amount:(int)arg5;
...
- (void)fullyLoadIfNeededAroundPos:(intpair)arg1 clientLightBlockIndex:(int)arg2 forBlockhead:(id)arg3;
- (void)fullyLoadAndUpdateIfNeededForMacroBlock:(struct MacroTile *)arg1 includingPos:(intpair)arg2 clientLightBlockIndex:(int)arg3 forBlockhead:(id)arg4;
...
- (void)queueBlockheadAIActionToTile:(struct Tile *)arg1 atPos:(intpair)arg2 forBlockhead:(id)arg3;
- (void)cancelAllActionsAtPos:(intpair)arg1 orWithInteractionObjectID:(unsigned long long)arg2;
...
- (float)getWeatherFractionForPos:(intpair)arg1 atWorldTime:(double)arg2 ignoreSandFraction:(BOOL)arg3;
- (float)getWeatherFractionForPos:(intpair)arg1 atWorldTime:(double)arg2;
- (void)removePaintAtTile:(struct Tile *)arg1 atPos:(intpair)arg2 faceIndex:(unsigned char)arg3 paintBlockhead:(id)arg4;
- (void)paintTile:(struct Tile *)arg1 atPos:(intpair)arg2 colorIndex:(unsigned short)arg3 faceIndex:(unsigned char)arg4 paintBlockhead:(id)arg5;
- (void)remoteGatherRequest:(id)arg1;
- (void)sendGatherNotificationForTile:(struct Tile *)arg1 atPos:(intpair)arg2;
- (void)fillTile:(struct Tile *)arg1 atPos:(intpair)arg2 withType:(int)arg3 dataA:(unsigned short)arg4 dataB:(unsigned short)arg5 placedByClient:(id)arg6 saveDict:(id)arg7 placedByBlockhead:(id)arg8 placedByClientName:(id)arg9;
- (void)fillTile:(struct Tile *)arg1 atPos:(intpair)arg2 withType:(int)arg3 dataA:(unsigned short)arg4 dataB:(unsigned short)arg5 placedByClient:(id)arg6 saveDict:(id)arg7 placedByClientName:(id)arg8;
...
- (id)placeInteractionObjectWithItem:(id)arg1 atPos:(intpair)arg2 saveDict:(id)arg3 placedByClient:(id)arg4 placedByBlockhead:(id)arg5 placedByClientName:(id)arg6;
- (void)remotePlaceInteractionObjectRequest:(id)arg1 fromPeer:(id)arg2;
- (void)placeWorkbenchOfType:(int)arg1 atPos:(intpair)arg2 saveDict:(id)arg3 placedByClient:(id)arg4 placedByBlockhead:(id)arg5 placedByClientName:(id)arg6;
- (void)remotePlaceWorkbenchRequest:(id)arg1 fromPeer:(id)arg2;
- (void)updateTileGraphicForWorkbenchOfType:(int)arg1 atPos:(intpair)arg2 level:(int)arg3;
...
- (void)removeAnyBackgroundContentsForTile:(struct Tile *)arg1 atPos:(intpair)arg2 removeBlockhead:(id)arg3;

...
@interface World : NSObject
{
    ...
    BOOL calibrating;
    BOOL hasCalibrated;
    struct Vector longTermAveragedAcceleration;
    ...
    BOOL loadComplete;
    CDStruct_ffe6b7c1 startPortalPos;
    ...
    Shader *lightsShader;
    struct Vector2 roundedTranslation;
    struct Vector2 accurateTranslation;
    struct Vector2 translationGoal;
    BOOL translatingToGoal;
    double worldTime;
    NoiseFunction *weatherNoiseFunction;
    struct Vector sunDirection;
    ...
    CDStruct_ffe6b7c1 highestPoint;
    ...
    struct map<int, unsigned char *, std::__1::less<int>, std::__1::allocator<std::__1::pair<const int, unsigned char *>>> latestMapData;
    ...
    struct Vector2 touchStartTranslation;
    struct Vector2 lastPinchPanTranslation;
    struct Vector2 lastDistanceTravelledThisDPadMovement;
    BOOL dpadControl;
    ...
    CDStruct_ffe6b7c1 repairModeConfirmPos;
}
...
@property(readonly) BOOL isHeadingTowardsMIdday; // @synthesize isHeadingTowardsMIdday;
@property(readonly) struct Vector2 roundedTranslation; // @synthesize roundedTranslation;
...
@property(readonly) PortalChestManager *portalChestManager; // @synthesize portalChestManager;
...
@property(readonly) NSMutableDictionary *serverClients; // @synthesize serverClients;
@property(readonly) CDStruct_ffe6b7c1 startPortalPos; // @synthesize startPortalPos;
@property(readonly) struct WindowInfo *windowInfo; // @synthesize windowInfo;
@property(readonly) int incrementalLoadCount; // @synthesize incrementalLoadCount;
@property(readonly) BOOL loadComplete; // @synthesize loadComplete;
@property BOOL translatingToGoal; // @synthesize translatingToGoal;
@property(readonly) struct Vector dayColor; // @synthesize dayColor;
@property(readonly) float rainFractionNotIncludingSnow; // @synthesize rainFractionNotIncludingSnow;
...
@property(readonly) struct Vector sunDirection; // @synthesize sunDirection;
...
- (float)sandFractionForPos:(CDStruct_ffe6b7c1)arg1;
...
- (BOOL)tileIsProtectedAtPos:(CDStruct_ffe6b7c1)arg1 againstBlockhead:(id)arg2;
- (BOOL)tileIsProtectedAtPos:(CDStruct_ffe6b7c1)arg1 againstClient:(id)arg2;
- (void)ownershipSignWasPlacedOrChangedAtPos:(CDStruct_ffe6b7c1)arg1 withLandOwner:(id)arg2 widthRadius:(int)arg3 heightRadius:(int)arg4 wasRemoved:(BOOL)arg5;
- (void)signOwnershipModificationRecievedFromServer:(id)arg1;
- (void)updateLocalOwnershipSignsDueToSignPlacedOrChangedAtPos:(CDStruct_ffe6b7c1)arg1 withLandOwner:(id)arg2 widthRadius:(int)arg3 heightRadius:(int)arg4 wasRemoved:(BOOL)arg5;
...
- (void)reportUserWithName:(id)arg1 reporterName:(id)arg2 reporterMessage:(id)arg3 reportedAvatarImagePath:(id)arg4;
- (BOOL)isCloudGame;
...
- (void)sendNetDataForElectricityParticlePathIfRequired:(vector_4ecf5f14)arg1 size:(float)arg2 ignoreClient:(id)arg3;
...
- (void)fireProjectileFrom:(struct Vector2)arg1 to:(struct Vector2)arg2 at:(id)arg3 fireItemType:(int)arg4 firer:(id)arg5;
- (void)zoomToPortalAtPosition:(CDStruct_ffe6b7c1)arg1;
- (void)incentivizedVideoViewComplete:(BOOL)arg1;
- (BOOL)mapVisible;
- (BOOL)tileIsLitForClient:(id)arg1 atPos:(CDStruct_ffe6b7c1)arg2 tile:(struct Tile *)arg3;
...
- (CDStruct_ffe6b7c1)activeBlockheadPos;
- (void)zoomToPos:(CDStruct_ffe6b7c1)arg1 pinchZoom:(BOOL)arg2;
- (void)zoomToPoint:(struct Vector2)arg1;
- (void)remoteZoomRequestReturnedWithSuccess:(BOOL)arg1 point:(CDStruct_ffe6b7c1)arg2;
- (CDStruct_ffe6b7c1)getBlockheadZoomPosForClient:(id)arg1 requesterClient:(id)arg2 cycleIndex:(int)arg3;
...
- (void)iapStarted;
- (void)waterMovedFrom:(CDStruct_ffe6b7c1)arg1 fromTile:(struct Tile *)arg2 to:(CDStruct_ffe6b7c1)arg3 toTile:(struct Tile *)arg4 amount:(int)arg5;
- (void)abortInProgressPathIfForBlockhead:(id)arg1;
- (struct Vector)currentTipColor;
- (id)currentTipText;
...
- (void)requestForBlock:(struct ClientMacroBlockRequest)arg1 fromClient:(id)arg2;
...
- (BOOL)allowsRotation;
- (void)saveSunlightChangedAtPos:(CDStruct_ffe6b7c1)arg1;
...
- (void)removeDynamicObjectTappedAtDynamicObject:(id)arg1 withBlockhead:(id)arg2;
- (void)warpInBlockhead:(id)arg1 atWorkbench:(id)arg2 withBlockhead:(id)arg3;
- (void)teleportToWorkbench:(id)arg1 withBlockhead:(id)arg2 craftableItemObject:(id)arg3;
...
- (void)blockheadReachedInteractionObjectDestination:(id)arg1 pathExtraData:(id)arg2;
- (void)craftOrConfigureItem:(id)arg1 atWorkbench:(id)arg2 withBlockhead:(id)arg3 count:(int)arg4;
- (void)craftItem:(id)arg1 atWorkbench:(id)arg2 withBlockhead:(id)arg3 count:(int)arg4;
- (void)craftAbortedForWorkbench:(id)arg1 withBlockhead:(id)arg2;
- (void)craftItemFinished:(id)arg1 atWorkbench:(id)arg2 allFinished:(BOOL)arg3 blockhead:(id)arg4;
- (void)fullyLoadIfNeededAroundPos:(CDStruct_ffe6b7c1)arg1 clientLightBlockIndex:(int)arg2 forBlockhead:(id)arg3;
- (void)fullyLoadAndUpdateIfNeededForMacroBlock:(struct MacroTile *)arg1 includingPos:(CDStruct_ffe6b7c1)arg2 clientLightBlockIndex:(int)arg3 forBlockhead:(id)arg4;
...
- (void)loadPhysicalBlockForMacroTile:(struct MacroTile *)arg1 atX:(int)arg2 y:(int)arg3 loadSurroundingBlocks:(BOOL)arg4 createIfNotCreated:(BOOL)arg5;
- (struct PhysicalBlock *)physicalBlockToLoadByClientTileLoaderForMacroTile:(struct MacroTile *)arg1;
- (void)saveLightBlockForClientLightBlockIndex:(int)arg1 physicalBlock:(struct PhysicalBlock *)arg2 sendNow:(BOOL)arg3;
- (void)loadLightBlockForClientLightBlockIndex:(int)arg1 intoPhysicalBlock:(struct PhysicalBlock *)arg2;
- (void)loadDynamicObjectsIfNotAlreadyLoadedForMacroTile:(struct MacroTile *)arg1 includeSurfaceBlocks:(BOOL)arg2;
- (void)decommisionBlock:(struct MacroTile *)arg1 blockToSavePhyscialBlock:(BOOL)arg2;
- (BOOL)savePhysicalBlockForMacroTile:(struct MacroTile *)arg1 sendReliably:(BOOL)arg2 dontSend:(BOOL)arg3 onlySaveIfClientsNeedIt:(BOOL)arg4;
...
- (void)queueBlockheadAIActionToTile:(struct Tile *)arg1 atPos:(CDStruct_ffe6b7c1)arg2 forBlockhead:(id)arg3;
- (void)cancelAllActionsAtPos:(CDStruct_ffe6b7c1)arg1 orWithInteractionObjectID:(unsigned long long)arg2;
- (void)zoomUIToOnscreen:(struct Vector2)arg1 dimensions:(struct Vector2)arg2;
- (void)render:(float)arg1 cameraZ:(float)arg2 projectionMatrix:(union _GLKMatrix4)arg3 pinchScale:(float)arg4;
- (struct Vector)lightPositionLeft;
- (struct Vector)lightPositionRight;
- (struct Vector)lightPositionFront;
- (struct Vector)lightPositionTop;
- (void)preRenderUpdate:(float)arg1 fastSlowDT:(float)arg2 cameraZ:(float)arg3 projectionMatrix:(union _GLKMatrix4)arg4;
- (struct Vector)dayColorForPosition:(CDStruct_ffe6b7c1)arg1;
- (float)getDayNightFractionForX:(float)arg1 atWorldTime:(double)arg2;
- (float)getWeatherFractionForPos:(CDStruct_ffe6b7c1)arg1;
- (float)getWeatherFractionForPos:(CDStruct_ffe6b7c1)arg1 atWorldTime:(double)arg2 ignoreSandFraction:(BOOL)arg3;
- (float)getWeatherFractionForPos:(CDStruct_ffe6b7c1)arg1 atWorldTime:(double)arg2;
- (void)removePaintAtTile:(struct Tile *)arg1 atPos:(CDStruct_ffe6b7c1)arg2 faceIndex:(unsigned char)arg3 paintBlockhead:(id)arg4;
- (void)paintTile:(struct Tile *)arg1 atPos:(CDStruct_ffe6b7c1)arg2 colorIndex:(unsigned short)arg3 faceIndex:(unsigned char)arg4 paintBlockhead:(id)arg5;
- (void)remoteGatherRequest:(id)arg1;
- (void)sendGatherNotificationForTile:(struct Tile *)arg1 atPos:(CDStruct_ffe6b7c1)arg2;
- (void)fillTile:(struct Tile *)arg1 atPos:(CDStruct_ffe6b7c1)arg2 withType:(int)arg3 dataA:(unsigned short)arg4 dataB:(unsigned short)arg5 placedByClient:(id)arg6 saveDict:(id)arg7 placedByBlockhead:(id)arg8 placedByClientName:(id)arg9;
- (void)fillTile:(struct Tile *)arg1 atPos:(CDStruct_ffe6b7c1)arg2 withType:(int)arg3 dataA:(unsigned short)arg4 dataB:(unsigned short)arg5 placedByClient:(id)arg6 saveDict:(id)arg7 placedByClientName:(id)arg8;
- (void)fillTile:(struct Tile *)arg1 atPos:(CDStruct_ffe6b7c1)arg2 withType:(int)arg3;
- (void)remotePaintRequest:(id)arg1 fromClient:(id)arg2;
- (unsigned int)remoteFillRequest:(id)arg1 placedByClient:(id)arg2;
- (id)placeInteractionObjectWithItem:(id)arg1 atPos:(CDStruct_ffe6b7c1)arg2 saveDict:(id)arg3 placedByClient:(id)arg4 placedByBlockhead:(id)arg5 placedByClientName:(id)arg6;
- (void)remotePlaceInteractionObjectRequest:(id)arg1 fromPeer:(id)arg2;
- (void)placeWorkbenchOfType:(int)arg1 atPos:(CDStruct_ffe6b7c1)arg2 saveDict:(id)arg3 placedByClient:(id)arg4 placedByBlockhead:(id)arg5 placedByClientName:(id)arg6;
- (void)remotePlaceWorkbenchRequest:(id)arg1 fromPeer:(id)arg2;
- (void)updateTileGraphicForWorkbenchOfType:(int)arg1 atPos:(CDStruct_ffe6b7c1)arg2 level:(int)arg3;
- (void)removeWaterTileAtPos:(CDStruct_ffe6b7c1)arg1;
- (void)removeTileAtWorldX:(int)arg1 worldY:(int)arg2 createContentsFreeblockCount:(int)arg3 createForegroundContentsFreeblockCount:(int)arg4 removeBlockhead:(id)arg5 onlyRemoveCOntents:(BOOL)arg6 onlyRemoveForegroundContents:(BOOL)arg7 sendWorldChangedNotifcation:(BOOL)arg8 dontRemoveContents:(BOOL)arg9;
- (void)removeBackWallAtPos:(CDStruct_ffe6b7c1)arg1 removeBlockhead:(id)arg2;
- (BOOL)shouldBeCrystalBlockAtPos:(CDStruct_ffe6b7c1)arg1;
- (void)removeTileAtWorldX:(int)arg1 worldY:(int)arg2 createContentsFreeblockCount:(int)arg3 createForegroundContentsFreeblockCount:(int)arg4 removeBlockhead:(id)arg5 onlyRemoveCOntents:(BOOL)arg6 onlyRemoveForegroundContents:(BOOL)arg7;
- (void)removeTileAtWorldX:(int)arg1 worldY:(int)arg2 createContentsFreeblockCount:(int)arg3 createForegroundContentsFreeblockCount:(int)arg4 removeBlockhead:(id)arg5;
...
- (void)removeAnyBackgroundContentsForTile:(struct Tile *)arg1 atPos:(CDStruct_ffe6b7c1)arg2 removeBlockhead:(id)arg3;
- (void)decommisionAllBlocksBlockToSavePhyscialBlock:(BOOL)arg1;
- (void)update:(float)arg1 accurateDT:(float)arg2 pinchScale:(double)arg3 dragInProgress:(BOOL)arg4;
- (float)simulationProgress;
...
- (void)addSimulationEventOfType:(int)arg1 forBlockhead:(id)arg2 extraData:(id)arg3;
- (BOOL)isSimulating;
...
- (id)initWithWindowInfo:(struct WindowInfo *)arg1 cache:(id)arg2 delegate:(id)arg3 saveID:(id)arg4 name:(id)arg5 client:(id)arg6 server:(id)arg7 multiplayerWorldData:(id)arg8 serverHostData:(id)arg9 saveDelay:(int)arg10 worldWidthMacro:(int)arg11 customRules:(id)arg12 expertMode:(BOOL)arg13;
...
- (id)heartbeatData;
- (id)summaryNetDataForAdmin:(BOOL)arg1 mod:(BOOL)arg2 owner:(BOOL)arg3 cloudMode:(int)arg4;
- (struct Vector2)translation;
- (void)setTranslation:(struct Vector2)arg1;
- (void)updateTranslationDueToPinchOrPan:(struct Vector2)arg1;

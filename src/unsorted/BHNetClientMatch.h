...
@class NSDictionary, NSMutableArray, NSMutableDictionary, NSNetServiceBrowser, NSString, NSTimer;
@protocol BHNetClientSearchDelegate;

@interface BHNetClientMatch : BHMatch <NSNetServiceBrowserDelegate, NSNetServiceDelegate>
{
...
- (void)pollNetEvents;
- (id)initWithSearchDelegate:(id)arg1 host:(id)arg2 port:(id)arg3 userName:(id)arg4 userPhoto:(id)arg5 cloudKey:(id)arg6;
